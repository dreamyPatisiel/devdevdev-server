...
class PickControllerTest extends SupportControllerTest {
    ...
    void registerPickComment() throws Exception {
        ...
        // when // then
        mockMvc.perform(post("/devdevdev/api/v1/picks/comments")
                        .contentType(MediaType.APPLICATION_JSON)
                        .header(SecurityConstant.AUTHORIZATION_HEADER, SecurityConstant.BEARER_PREFIX + accessToken)
                        .characterEncoding(StandardCharsets.UTF_8)
    ...
    void registerPickCommentBindExceptionPickOptionIdIsNull(String contents) throws Exception {
        ...
        RegisterPickCommentRequest registerPickCommentRequest = new RegisterPickCommentRequest(pick.getId(), contents,
                firstPickOption.getId(), true);
