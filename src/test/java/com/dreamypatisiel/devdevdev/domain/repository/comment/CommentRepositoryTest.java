...
class CommentRepositoryTest {
    ...
    @Test
    @DisplayName("회원이 작성하고 삭제상태가 아닌 픽픽픽, 기술블로그 댓글을 작성시간 내림차순으로 조회한다.")
    void findMyWrittenCommentsByCursorCursor() {
        // given
        ...
        assertThat(findMyWrittenComments.getContent()).hasSize(6)
