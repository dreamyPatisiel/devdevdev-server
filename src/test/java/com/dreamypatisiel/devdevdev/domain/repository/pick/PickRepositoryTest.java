...
class PickRepositoryTest {
    ...
    void findPicksByLtPickId() {
        ...
        // when
        Slice<Pick> picks = pickRepository.findPicksByLtPickId(pageable, null, null);
    ...
    void findPicksByLtPickIdOrderByViewCountDesc() {
        ...
        // when
        Slice<Pick> picks = pickRepository.findPicksByLtPickId(pageable, null, PickSort.MOST_VIEWED);
    ...
    void findPicksByLtPickIdOrderByCreatedAtDesc() {
        ...
        // when
        Slice<Pick> picks = pickRepository.findPicksByLtPickId(pageable, null, PickSort.LATEST);
    ...
    void findPicksByLtPickIdOrderByDesc() {
        ...
        // when
        Slice<Pick> picks = pickRepository.findPicksByLtPickId(pageable, null, PickSort.MOST_COMMENTED);
    ...
    void findPicksByLtPickIdOrderByPopular() {
        ...
        // when
        Slice<Pick> picks = pickRepository.findPicksByLtPickId(pageable, null, PickSort.POPULAR);
