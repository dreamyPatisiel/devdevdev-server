...
@Component
public class TechBestCommentsPolicy implements BestCommentPolicy {

    public static final int BEST_COMMENTS_MAX_OFFSET = 10;
    public static final int BEST_COMMENTS_DEFAULT_OFFSET = 3;

    /**
     * @Note: 베스트 댓글 size 정책을 적용하여 예측 불가능한 자원 낭비를 방지한다.(최소 3개 최대 10개)
     * @Author: 장세웅
     * @Since: 2024.10.27
     */
    public int applySize(int size) {
        if (size > BEST_COMMENTS_MAX_OFFSET || size < BEST_COMMENTS_DEFAULT_OFFSET) {
