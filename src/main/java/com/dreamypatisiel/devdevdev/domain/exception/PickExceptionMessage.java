...
public class PickExceptionMessage {
    ...
    public static final String INVALID_CAN_NOT_ACTION_DELETED_PICK_COMMENT_MESSAGE = "삭제된 픽픽픽 댓글에는 %s할 수 없습니다.";
    ...
    public static final String INVALID_NOT_APPROVAL_STATUS_PICK_REPLY_MESSAGE = "승인 상태가 아닌 픽픽픽에는 답글을 %s할 수 없습니다.";
